...
?>
        ...
        <main role="main">
            <div class="jumbotron">
                <div class="container">
                    <h1 class="display-4">Supprimer des étudiants</h1>
                        ...
                        function refresh() {
                            ...
                            function myFunction(response) {
                                ...
                                if (obj.success == 1) {
                                    ...
                                    var i;
                                    var out = "<table class=\"table table-striped table-hover\" ><tr><th>CIN</th><th>Nom </th><th>Prénom</th><th>Adresse</th><th>Email</th><th>Classe</th><th> </th></tr>";
                                    ...
                                    for (i = 0; i < arr.length; i++) {
                                        out += "<tr><td>" +
                                            ...
                                            arr[i].groupe +
                                            "</td><td>"+
                                            "<button type=\"button\" class=\"btn btn-default btn-sm\"><i class=\"fas fa-trash\"></i> <a href=\"supprimer.php?cin="+arr[i].cin+"\" onclick=\"return confirm('Voulez-vous vraiment le supprimer?')\">supprimer</a> </button>"+
                                            "</td></tr>";
                                    }
                                    out += "</table>";
